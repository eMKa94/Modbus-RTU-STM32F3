...
#define boardRs485SetDirTx()       LL_GPIO_ResetOutputPin(boardRs485DirPort_def, boardRs485DirPin_def);
#define boardRs485SetDirRx()       LL_GPIO_SetOutputPin(boardRs485DirPort_def, boardRs485DirPin_def);
...
ErrorStatus boardRs485DirInit(void)
{
    ...
    boardRs485Dir.Speed      = LL_GPIO_SPEED_FREQ_HIGH;
